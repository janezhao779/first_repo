...
print(f'The total of loans is {total_of_loans}')

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
# YOUR CODE HERE!
average_of_loan = total_of_loans / number_of_loans
print(f'The Average of loan is {average_of_loan}')
...
# YOUR CODE HERE!
    print(inexpensive_loans(loan_price))
...
with open ('inexpensive_loans.csv' , 'w') as new_file:
      header = ["loan_price", "remaining_months",
          "repayment_interval", "future_value"]
      csv_writer = csv.DictWriter(new_file, header = header, delimiter='_\t_')

      csv_writer = csv.writeheader()
